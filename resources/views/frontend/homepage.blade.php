...
<!-- Merged Card Section -->
<section class="relative bg-[#e8e8e8] py-28">
    <div>
        <div
            class="grid max-w-screen-xl grid-cols-1 mx-auto overflow-hidden bg-white border border-gray-100 shadow-2xl md:grid-cols-3 -mt-60">

            <!-- Card 1 -->
            <div class="relative p-12 mt-10 bg-white shadow-xl group">
                <!-- Green Corner (Inset) -->
                <div
                    class="absolute top-6 left-6 w-0 h-0 border-t-[40px] border-t-[#1E4D2B] border-r-[40px] border-r-transparent rounded-tl-md">
                </div>
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div
                        class="text-6xl font-bold text-gray-300 select-none -mt-10 outlined-number transition-colors duration-300 group-hover:text-[#1E4D2B]">
                        01
                    </div>
                </div>
            ...
            <!-- Card 2 -->
            <div class="relative p-12 mt-10 bg-white group">
                <div
                    class="absolute top-6 left-6 w-0 h-0 border-t-[40px] border-t-[#1E4D2B] border-r-[40px] border-r-transparent rounded-tl-md">
                </div>
...
<section class="relative bg-[#e8e8e8] py-20">
    ...
    <div class="relative z-10 grid items-center max-w-screen-xl grid-cols-1 gap-16 mx-auto md:grid-cols-2">
        ...
        <div class="relative group">
            ...
            <div class="relative z-10">
                ...
                <p class="mb-5 text-lg font-semibold leading-relaxed text-gray-700">
                    Architex Phil., Inc. is a newly established Architectural Design Firm that is dedicated to provide
                    clients with
                    the most personalized services in Architectural Design, Buildings and Interior Designs, Project
                    Management and
                ...
                <p class="mb-8 text-lg font-semibold leading-relaxed text-gray-700">
                    ...
                    Projects in some
                    area of Mindanao and are committed to expand our services to the global arena.
                </p>
        ...
        <div class="flex items-center justify-center">
            <div class="w-full">
                <img src="{{ asset('img/homepage/house.png') }}" alt="Project" class="object-cover w-full h-full" />
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative z-10 max-w-screen-xl px-6 mx-auto text-center">
        ...
        <div class="space-y-10">
            ...
            <x-service-card title="Property for Rent"
                ...
                button-text="See All For Rent" button-link="{{ route('properties') }}" image="img/homepage/rent.png" :reverse="true" />
        </div>
    </div>
</section>
...
<section id="blogs" class="relative w-full pt-20 pb-[20rem] bg-[#e8e8e8]">
    <div class="relative z-10 max-w-screen-xl mx-auto">
        <!-- Section Header -->
        <div class="relative z-10 px-6 mx-auto max-w-screen-2xl">
            <div class="flex flex-col mb-12 md:flex-row md:items-center md:justify-between">
                ...
                <div class="relative">
                    ...
                    <p class="relative mb-4 text-sm font-bold text-green-700 uppercase">
                        Blogs
                    </p>
        ...
        <div class="relative px-6">
            ...
            <div class="absolute inset-0 flex items-center justify-between px-2 md:px-4 z-20 pointer-events-none">
                <!-- Prev Button -->
                <button
                    class="blog-swiper-button-prev pointer-events-auto bg-green-900 text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-green-700 shadow-md z-30 transition">
                ...
                <!-- Next Button -->
                <button
                    class="blog-swiper-button-next pointer-events-auto bg-green-900 text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-green-700 shadow-md z-30 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="2.5" stroke="currentColor" class="w-5 h-5">
