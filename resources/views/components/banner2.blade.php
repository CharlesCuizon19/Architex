...
<div>
    <div class="flex flex-col">
        <div class="grid grid-cols-2">
            <div class="bg-[#253E16]">
                <section class="ml-[9rem] flex gap-20 py-8 text-white lg:px-10 2xl:gap-52">
            ...
            <div class="flex items-center justify-end bg-white">
                <section class="px-10 py-2 mr-[9rem]">
        ...
        <div class="relative">
            <div>
                <img src="{{ asset('img/about-us-banner.png') }}" alt="">
            </div>
            ...
            <div class="absolute top-0 z-20 flex justify-center w-full">
                <div>
                    <x-header2 />
                </div>
            </div>
