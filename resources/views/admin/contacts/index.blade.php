    ...
    <table class="table-fixed w-full border-collapse text-center"
        ...
        <thead>
            <tr class="bg-black text-white text-sm font-semibold">
                ...
                <th class="px-10 py-3 w-1/4">Phone Number</th>
                <th class="px-10 py-3 w-1/4">Subject</th>
                <th class="px-10 py-3 w-1/4">Message</th>
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="px-10 py-3">{{ $contact->name }}</td>
                <td class="px-10 py-3">{{ strip_tags($contact->email) }}</td>
                <td class="px-10 py-3">{{ strip_tags($contact->phone_number) }}</td>
